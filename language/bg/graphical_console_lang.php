...
$lang['graphical_console_welcome_message'] = 'Добре дошли! Тази конзола се използва за конфигуриране на мрежовите настройки на тази система. След като сте си мрежа и работи, можете да инсталирате, конфигурирате и управлявате приложения с помощта на стандартен уеб браузър.';
$lang['graphical_console_what_next_help'] = 'След като сте конфигурирали вашата мрежа и свързани към тази система с вашия уеб браузър, съветникът за инсталиране ще ви преведе през стъпките завършите инсталацията.';
$lang['graphical_console_what_next'] = 'Какво следва?';
